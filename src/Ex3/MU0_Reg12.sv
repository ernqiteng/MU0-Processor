...
//
// Comments:
// creates a 12 bit register (fast-access memory location) to be used in the datapath of the MU0 processor
...
// module definition - holds data value

module MU0_Reg12 (
input  logic          Clk, 
input  logic          Reset,     
input  logic          En, //clock enable input
input  logic   [11:0] D, //12 data input
output logic   [11:0] Q //12 bit output
);
